          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4B2E83]/20 focus:border-[#4B2E83] resize-none"
              />
            </div>
                ...
                {section.features.map((feature, i) => (
                  <div key={i} className="p-4 bg-gray-50 rounded-lg space-y-3">
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4B2E83]/20"
                    />
                    <textarea
                      ...
                      rows={2}
                      className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4B2E83]/20 resize-none"
                    />
                  </div>
                ))}
              </div>

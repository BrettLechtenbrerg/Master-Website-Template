...
import { Tv, Star, Calendar, ArrowRight, Play, Clock, MapPin } from 'lucide-react';
...
const featuredSegments = [
  {
    ...
    description: 'Chamber Executive Director Amanda Foster highlights local businesses and holiday shopping in Murray.',
    business: 'Murray Area Chamber of Commerce',
  },
  {
    title: 'Small Business Success Story',
    date: 'November 20, 2025',
    description: 'Bloom Floral Design shares their journey from startup to award-winning Murray business.',
    business: 'Bloom Floral Design',
  },
  {
    title: 'Tech Innovation in Murray',
    date: 'October 8, 2025',
    description: 'Murray Tech Solutions discusses the growing tech sector in our community.',
      ...
      <section className="relative py-16 overflow-hidden">
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="aspect-video bg-gradient-to-br from-purple-600/30 to-orange-500/30 rounded-xl flex items-center justify-center mb-6">

          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <textarea
                ...
                className="w-full h-48 p-4 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4B2E83]/20 focus:border-[#4B2E83] resize-none text-gray-900 placeholder-gray-400"
              />
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4B2E83]/20 focus:border-[#4B2E83] text-gray-900 placeholder-gray-400"
                />
                <button
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {output && (
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={useAsInput}
                      className="flex items-center gap-2 px-3 py-1.5 text-sm bg-[#4B2E83]/10 text-[#4B2E83] rounded-lg hover:bg-[#4B2E83]/20"
                    >
                      Use as Input
                    </button>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <Zap size={20} className="text-[#4B2E83]" />
                Quick Actions
              </h2>
              <div className="grid grid-cols-2 gap-2">
                {quickActions.map((action) => (
                  <button
                    ...
                    disabled={loading || !content.trim()}
                    className="px-3 py-2 text-sm bg-gray-100 text-gray-900 hover:bg-[#4B2E83] hover:text-white rounded-lg transition-colors disabled:opacity-50"
                  >
                    {action.name}
                  </button>
                ))}

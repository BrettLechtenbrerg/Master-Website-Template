  ...
  if (data === null || data === undefined) {
    return (
      <input
        ...
        className="px-3 py-2 border border-gray-200 rounded-lg text-sm w-full focus:ring-2 focus:ring-[#4B2E83]/20 focus:border-[#4B2E83] text-gray-900"
      />
    );
  }
    ...
    if (data.length > 100 || data.includes('\n')) {
      return (
        <textarea
          ...
          className="px-3 py-2 border border-gray-200 rounded-lg text-sm w-full min-h-[80px] resize-y focus:ring-2 focus:ring-[#4B2E83]/20 focus:border-[#4B2E83] text-gray-900"
          rows={3}
        />
      );
    }
  ...
  if (typeof data === 'number') {
    return (
      <input
        ...
        value={data}
        onChange={(e) => onChange(path, e.target.value)}
        className="px-3 py-2 border border-gray-200 rounded-lg text-sm w-32 focus:ring-2 focus:ring-[#4B2E83]/20 focus:border-[#4B2E83] text-gray-900"
      />
    );
  }
        ...
        {!isCollapsed && (
          <div className="p-3 space-y-3 bg-white">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm text-[#4B2E83] hover:bg-[#4B2E83]/10 rounded-lg w-full"
            >
              <Plus size={14} />
              Add Item
            </button>
        ...
        <div className="">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-medium transition-all shadow-lg ${
                saving
                  ...
                  : hasChanges
                  ? 'bg-gradient-to-r from-[#4B2E83] to-orange-600 text-white hover:from-orange-600 hover:to-orange-700 shadow-orange-500/20'
          ...
          {loading ? (
            <div className="flex items-center justify-center py-12">
              <Loader2 size={32} className="animate-spin text-[#4B2E83]" />
            </div>
          ) : content ? (

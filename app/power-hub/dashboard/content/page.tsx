  ...
  return (
    <div>
      ...
      <div className="p-8">
        <div className="">
          {/* Info Banner */}
          <div className="flex items-center gap-3 p-4 bg-[#4B2E83]/5 border border-[#4B2E83]/20 rounded-xl text-[#4B2E83] mb-6">
            <Github size={20} />
            <div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                <FileJson className="w-5 h-5 text-[#4B2E83]" />
                Content Files
              </h2>
            ...
            {loading ? (
              <div className="p-8 text-center">
                <Loader2 className="w-8 h-8 text-[#4B2E83] animate-spin mx-auto" />
              ...
              <div className="divide-y divide-gray-100">
                {contentFiles.map((file) => (
                  <Link
                    ...
                    className="flex items-center justify-between p-5 hover:bg-[#4B2E83]/5 transition-colors group"
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-xl bg-[#4B2E83]/10 flex items-center justify-center group-hover:bg-[#4B2E83] transition-colors">
                        <FileJson className="w-6 h-6 text-[#4B2E83] group-hover:text-white transition-colors" />
                      </div>
                      <div>

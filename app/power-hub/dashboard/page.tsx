              ...
              <div key={stat.name} className="bg-white rounded-xl border border-gray-200 p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[#4B2E83] mt-2 flex items-center gap-1">
                      <TrendingUp size={12} />
                      {stat.change}
                    </p>
                  </div>
                  <div className="w-12 h-12 bg-[#4B2E83]/10 rounded-xl flex items-center justify-center">
                    <Icon className="text-[#4B2E83]" size={24} />
                  </div>
                </div>
              </div>
            );
          ...
          {quickActions.map((action) => {
            ...
            return (
              <Link
                key={action.name}
                href={action.href}
                className="bg-white rounded-xl border border-gray-200 p-6 hover:border-[#4B2E83] hover:shadow-lg transition-all group"
              >

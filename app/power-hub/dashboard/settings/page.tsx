...
export default function SettingsPage() {
  ...
  const [siteUrl, setSiteUrl] = useState('https://web-seven-beta-31.vercel.app');
  ...
  const [currentUsername, setCurrentUsername] = useState('chamberadmin');
  ...
  const handleChangeCredentials = async () => {
    ...
    try {
      ...
      let storedPassword = 'chamber2026'; // Default
      let storedUsername = 'chamberadmin'; // Default
    ...
    <div>
      ...
      <div className="p-8">
        <div className="space-y-6 max-w-3xl">
          ...
          <div className="bg-white rounded-xl border-2 border-[#4B2E83] p-6">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-[#4B2E83] rounded-lg flex items-center justify-center">
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              <p className="text-sm text-gray-600">
                Current username: <span className="font-mono font-bold text-[#4B2E83]">{currentUsername}</span>
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4B2E83]/20 focus:border-[#4B2E83] transition-all text-gray-900 pr-12"
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4B2E83]/20 focus:border-[#4B2E83] transition-all text-gray-900"
                />
              </div>
              ...
              {newPassword && (
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4B2E83]/20 transition-all text-gray-900 ${
                      confirmPassword && confirmPassword !== newPassword
                        ? 'border-red-300 focus:border-red-500'
                        : 'border-gray-200 focus:border-[#4B2E83]'
                    }`}
                  />
                  {confirmPassword && confirmPassword !== newPassword && (
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#4B2E83] text-white rounded-lg hover:bg-[#7A59B5] transition-colors disabled:opacity-50 font-medium"
              >
                {credentialSaving ? (
                  <>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-[#4B2E83]/10 rounded-lg flex items-center justify-center">
                <Globe size={20} className="text-[#4B2E83]" />
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4B2E83]/20 focus:border-[#4B2E83] transition-all text-gray-900 placeholder-gray-400"
                />
              </div>
              ...
              <div className="flex justify-end pt-2">
                <button
                  ...
                  disabled={saving}
                  className="flex items-center gap-2 px-6 py-3 bg-[#4B2E83] text-white rounded-lg hover:bg-[#7A59B5] transition-colors disabled:opacity-50"
                >
                  {saving ? (
                    <>
                      <Loader2 size={18} className="animate-spin" />

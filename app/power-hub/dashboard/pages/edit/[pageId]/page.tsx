  ...
  if (!page) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="w-8 h-8 border-4 border-[#4B2E83] border-t-transparent rounded-full animate-spin" />
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={saving}
              className="flex items-center gap-2 px-6 py-2 bg-[#4B2E83] text-white rounded-lg hover:bg-[#7A59B5] transition-colors disabled:opacity-50"
            >
              <Rocket size={18} />
              Publish
            </button>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4B2E83]/20 focus:border-[#4B2E83]"
              />
            </div>
            <div>
          ...
          {page.sections.length === 0 ? (
            <div className="bg-white rounded-xl border border-gray-200 p-6 text-center py-12">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#4B2E83] text-white rounded-lg hover:bg-[#7A59B5] transition-colors"
              >
                <Plus size={18} />
                Add Section
              </button>
        ...
        {page.sections.length > 0 && (
          <div className="relative">
            <button
              ...
              className="w-full py-4 border-2 border-dashed border-gray-300 rounded-xl text-gray-500 hover:border-[#4B2E83] hover:text-[#4B2E83] hover:bg-[#4B2E83]/5 transition-all flex items-center justify-center gap-2"
            >
              <Plus size={20} />
              Add New Section
            </button>
                  ...
                  {sectionTypes.map((sectionType) => {
                    ...
                    return (
                      <button
                        ...
                        className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:border-[#4B2E83] hover:bg-[#4B2E83]/5 transition-all text-left"
                      >
                        <div className="w-10 h-10 bg-[#4B2E83]/10 rounded-lg flex items-center justify-center">
                          <Icon size={18} className="text-[#4B2E83]" />
                        </div>

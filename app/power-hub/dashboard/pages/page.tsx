    ...
    <div>
      ...
      <div className="p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-[#4B2E83] text-white rounded-lg hover:bg-[#7A59B5] transition-colors">
            <Plus size={18} />
            New Page
          </button>
        </div>
                  ...
                  <td className="py-4 px-6">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#4B2E83]/10 rounded-lg flex items-center justify-center">
                        <FileText size={18} className="text-[#4B2E83]" />
                      </div>
